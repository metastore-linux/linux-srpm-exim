...
%changelog
* Fri Dec 15 2017 Kitsune Solar <kitsune.solar@gmail.com> - 4.89.1-1
- New version
- Build from RHEL7
- Fixed: exim-4.89-config.patch convert to exim-4.89.1-config.patch for EXIM 4.89.1
- Fixed: (RHEL7) Used mysql-devel instead of mariadb-connector-c-devel
- Removed: Patch-28
- Removed: Patch-29
- Removed: Patch-30
- Removed: Patch-31
